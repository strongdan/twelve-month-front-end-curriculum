# One Year Plan to Learn Front-End Web Development

This is my personalized 52-week schedule to gain expertise with front-end JavaScript and front-end frameworks like Angular, React and Bootstrap. The first half of this schedule is centered around the Udacity [Mobile Web Specialist Nanodegree Program](https://www.udacity.com/course/mobile-web-specialist-nanodegree--nd024), but includes additional coursework to improve basic JavaScript knowledge. The second half of the program includes a lot of projects, front-end frameworks, the development process, computer science concepts, technical interview preparation and practice working with web APIs. Each week there is a course covering web development, one covering JavaScript, a book to review key concepts and coding practice using Free Code Camp, Exercism or Code Wars. 
...
- [ ] EdX [Asynchronous Programming with JS - Fundamentals](https://courses.edx.org/courses/course-v1:Microsoft+DEV234x+1T2018a/course/)
- [ ] Read [Jon Duckett's JavaScript & jQuery](https://www.amazon.com/JavaScript-JQuery-Interactive-Front-End-Development/dp/1118531647/)
- [ ] Work on [Code Wars](https://www.codewars.com/)

### Week 8 - May 31-June 6 - Promises
- [ ] Restaurant Reviews App 
...
### Week 11 - June 21-27 - Generators
- [ ] EdX [Asynchronous Programming with JS - Generators](https://courses.edx.org/courses/course-v1:Microsoft+DEV234x+1T2018a/course/)
- [ ] Udacity [ES6](https://www.udacity.com/course/es6-javascript-improved--ud356)
- [ ] Read [JavaScript: The Good Parts](http://shop.oreilly.com/product/9780596517748.do)
- [ ] Work through [Free Code Camp](http://beta.freecodecamp.org/)

### Week 12 - June 28-July 4 - ES6
...
## Month 4 - Offline Web Apps, Web Tooling and Automation
